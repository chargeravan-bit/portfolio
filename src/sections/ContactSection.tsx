            ...
            <div className="flex gap-3">
              {social.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="glass w-11 h-11 rounded-xl flex items-center justify-center text-lg hover:scale-110 transition-transform duration-300 glow-border"
                  data-cursor-hover
                >
                  {s.icon}
                </a>
            ...
            <div className="glass-strong rounded-3xl p-8 relative overflow-hidden">
              ...
              {status === 'sent' ? (
                <div className="flex flex-col items-center justify-center h-full py-12 text-center gap-4">
                  <div className="text-amber-400"><CheckCircle size={48} /></div>
                  <h3 className="text-xl font-bold gradient-text" style={{ fontFamily: 'var(--font-heading)' }}>
                    Message Sent!
                  </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl text-sm text-white placeholder:text-white/20 outline-none resize-none transition-all duration-300"
                      style={{
                        background: 'rgba(255,255,255,0.04)',
                        border: '1px solid rgba(255,255,255,0.08)',
                      }}
                  ...
                  <button
                    type="submit"
                    className="magnetic-btn w-full justify-center py-4"
                    data-cursor-hover
                  >
